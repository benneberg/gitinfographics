...
// used in: src/components/MarkdownEditor.tsx, src/components/mobile/FullScreenModalEditor.tsx, src/engine/extractors.ts, src/engine/parser.ts, src/engine/specBuilder.ts
...
export type SpecSection =
  | {
      id: string;
// used in: src/components/GroundingModal.tsx, src/engine/renderer.ts, src/engine/specBuilder.ts
...
// used in: src/App.tsx, src/components/GroundingModal.tsx, src/engine/specBuilder.ts
...
// used in: bin/cli.ts, src/App.tsx, src/components/GroundingModal.tsx, src/components/InfographicCanvas.tsx, src/components/SectionControls.tsx (+3 more)
...
// used in: bin/cli.ts, src/App.tsx, src/components/MarkdownEditor.tsx, src/components/mobile/FullScreenModalEditor.tsx, src/engine/github.ts (+2 more)
...
// used in: src/components/ContrastModal.tsx, src/engine/contrast.ts, src/engine/renderer.ts, src/engine/themes.ts

export type VariantMap = Record<string, number>;
// used in: bin/cli.ts, src/App.tsx, src/components/GroundingModal.tsx, src/components/SectionControls.tsx, src/engine/specBuilder.ts

export type VisualDensity = 'minimal' | 'medium' | 'dense';
// used in: src/App.tsx, src/components/DensitySelector.tsx, src/components/GroundingModal.tsx, src/components/SectionControls.tsx, src/engine/renderer.ts
